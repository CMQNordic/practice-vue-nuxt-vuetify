...
import MagicString from '@vue/reactivity-transform/node_modules/magic-string';
import { ParserPlugin } from '@babel/parser';
import { Program } from '@babel/types';
import { SourceMap } from '@vue/reactivity-transform/node_modules/magic-string';
...
export declare function transform(
	src: string,
	{ filename, sourceMap, parserPlugins, importHelpersFrom }?: RefTransformOptions,
): RefTransformResults;

export declare function transformAST(
	ast: Program,
	s: MagicString,
	offset?: number,
	knownRefs?: string[],
