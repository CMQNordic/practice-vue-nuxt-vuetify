...
export default abstract class Container<Child extends Node = ChildNode> extends Node {
	 ...
	 * @return Returns `false` if iteration was broke.
	 */
	walkRules(selectorFilter: string | RegExp, callback: (rule: Rule, index: number) => false | void): false | undefined;
	 ...
	 */
	append(...nodes: (Node | Node[] | ChildProps | ChildProps[] | string | string[])[]): this;
	 ...
	 * @return This node for methods chain.
	 */
	prepend(...nodes: (Node | Node[] | ChildProps | ChildProps[] | string | string[])[]): this;
	 ...
	 * @return This node for methods chain.
	 */
	insertBefore(oldNode: Child | number, newNode: Child | ChildProps | string | Child[] | ChildProps[] | string[]): this;
	 ...
	 * @return This node for methods chain.
	 */
	insertAfter(oldNode: Child | number, newNode: Child | ChildProps | string | Child[] | ChildProps[] | string[]): this;
	 ...
	 * @return This node for methods chain.
	 */
	replaceValues(pattern: string | RegExp, options: ValueOptions, replaced: string | { (substring: string, ...args: any[]): string }): this;
