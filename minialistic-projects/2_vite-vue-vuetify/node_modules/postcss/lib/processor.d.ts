import { AcceptedPlugin, Plugin, ProcessOptions, Transformer, TransformCallback } from 'postcss';
...
export default class Processor {
	 ...
	 */
	process(css: string | { toString(): string } | Result | LazyResult | Root, options?: ProcessOptions): LazyResult | NoWorkResult;
}
