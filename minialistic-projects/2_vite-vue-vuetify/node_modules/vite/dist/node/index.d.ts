...
export declare namespace HttpProxy {
	...
	export class Server extends events.EventEmitter {
		...
		on(
			event: 'proxyReq',
			listener: (proxyReq: http.ClientRequest, req: http.IncomingMessage, res: http.ServerResponse, options: ServerOptions) => void,
		): this;
		on(event: 'proxyRes', listener: (proxyRes: http.IncomingMessage, req: http.IncomingMessage, res: http.ServerResponse) => void): this;
		on(
			event: 'proxyReqWs',
			listener: (proxyReq: http.ClientRequest, req: http.IncomingMessage, socket: net.Socket, options: ServerOptions, head: any) => void,
		): this;
		on(
			event: 'econnreset',
...
declare class WebSocket_2 extends EventEmitter {
	...
	readonly readyState: typeof WebSocket_2.CONNECTING | typeof WebSocket_2.OPEN | typeof WebSocket_2.CLOSING | typeof WebSocket_2.CLOSED;
	readonly url: string;
	...
	constructor(address: string | URL_2, protocols?: string | string[], options?: WebSocket_2.ClientOptions | ClientRequestArgs);
	...
	addEventListener(method: 'message', cb: (event: WebSocket_2.MessageEvent) => void, options?: WebSocket_2.EventListenerOptions): void;
	addEventListener(method: 'close', cb: (event: WebSocket_2.CloseEvent) => void, options?: WebSocket_2.EventListenerOptions): void;
	addEventListener(method: 'error', cb: (event: WebSocket_2.ErrorEvent) => void, options?: WebSocket_2.EventListenerOptions): void;
	addEventListener(method: 'open', cb: (event: WebSocket_2.Event) => void, options?: WebSocket_2.EventListenerOptions): void;
	...
	on(event: 'unexpected-response', listener: (this: WebSocket_2, request: ClientRequest, response: IncomingMessage) => void): this;
	...
	once(event: 'unexpected-response', listener: (this: WebSocket_2, request: ClientRequest, response: IncomingMessage) => void): this;
	...
	off(event: 'unexpected-response', listener: (this: WebSocket_2, request: ClientRequest, response: IncomingMessage) => void): this;
